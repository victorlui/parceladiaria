...
export default function DocumentPhotoBackScreen() {
    ...
    >
      <View className="flex-1">
        ...
        <Text className="mb-4 text-base">
          Envie uma foto da parte do verso do documento (CPF ou RG) emitido em
          no máximo 10 anos.
        </Text>
        <View>
          <Text className="font-bold text-xl mb-1">Foto verso</Text>
        </View>
        <View className="flex-1">
          {!selectedDocFront && (
            <View className="flex-1">
          ...
          {selectedDocFront && (
            <>
              {selectedDocFront.type === "image" ? (
                <View className="w-full flex-1  h-52 mb-3">
                  <Image
