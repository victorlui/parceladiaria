      ...
      <View className="flex-1 px-6">
        ...
        <View className="flex flex-col gap-3 my-5">
          ...
          <Text className="text-base text-center">
            Envie uma foto da capa do contrato social ou certificado MEI com seu
            nome e endereço.
          </Text>
          <Text className="text-xl font-bold text-center text-[#33404F]">
            Comprove que o comércio é seu
          </Text>
        </View>
