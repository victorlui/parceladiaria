...
export default function EmailScreen() {
    ...
    return (
        <LayoutRegister isBack onContinue={handleSubmit(onSubmit)} loading={isPending}>
            ...
            <View className="flex-1">
                ...
                <View className="flex-1">
                    <FormInput control={control} label="E-mail" name="email" keyboardType="email-address" autoCapitalize="none" />
